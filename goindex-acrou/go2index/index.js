...
var authConfig = {
  ...
  theme: "acrou",
  // RECOMMENDED Gunakan client_id & client_secret milik sendiri 
...
class googleDrive {
  ...
  async search(origin_keyword, page_token = null, page_index = 0) {
    ...
    // Untuk korpora, pengguna adalah disk pribadi, dan drive adalah disk tim. Cocokkan driveId
    let params = {};
    if (is_user_drive) {
      params.corpora = "user";
    }
