self.props = {
	title: 'gdindex',
	default_root_id: 'root', // 'root' OR 0K0dce9h38dOUk9PVA
  // https://drive.google.com/drive/u/1/folders/0K0dce9h38dOUk9PVA
  ...
  // https://github.com/kiprox/goindex/tree/production/themes
...
(function () {
  ...
  async function onGet(request) {
    ...
    if (path.startsWith('/~_~_goindex/resources/')) {
      ...
      const r = await fetch(`https://raw.githubusercontent.com/kiprox/goindex/production/themes/material-vue-${self.props.ui}/${remain}`);
